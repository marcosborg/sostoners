                    ...
                    <tbody>
                        @foreach($crmNotes as $key => $crmNote)
                            <tr data-entry-id="{{ $crmNote->id }}">
                                ...
                                <td>
                                    {{ $crmNote->customer->last_name ?? '' }}
                                </td>
                                <td>
                                    {{ $crmNote->customer->email ?? '' }}
                                </td>
                                <td>
                                    {{ $crmNote->customer->phone ?? '' }}
                                </td>
                                <td>
                                    {{ $crmNote->customer->company ?? '' }}
                                </td>
                                <td>
                                    {{ $crmNote->customer->vat ?? '' }}
                                </td>
                                <td>
                                    @can('crm_note_show')
...
@endcan
  ...
  let table = $('.datatable-customerCrmNotes:not(.ajaxTable)').DataTable({ buttons: dtButtons })
