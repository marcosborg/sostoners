    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.assets.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('monthly_value') ? 'is-invalid' : '' }}" type="number" name="monthly_value" id="monthly_value" value="{{ old('monthly_value', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('offers') ? 'is-invalid' : '' }}" type="text" name="offers" id="offers" value="{{ old('offers', '') }}">
