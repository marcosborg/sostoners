    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-categoryAssets">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.asset.fields.customer') }}
                            </th>
                            <th>
                            ...
                            <th>
                                {{ trans('cruds.asset.fields.offers') }}
                            </th>
                            <th>
                                &nbsp;
                            </th>
...
@endcan
  ...
  let table = $('.datatable-categoryAssets:not(.ajaxTable)').DataTable({ buttons: dtButtons })
