...
class HomeController
{
    public function index()
    {
        ...
        $settings5 = [
            'chart_title'           => 'Reparações por dia',
            'chart_type'            => 'bar',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\Repair',
            'group_by_field'        => 'start_datetime',
            'group_by_period'       => 'day',
            'aggregate_function'    => 'count',
            'filter_field'          => 'created_at',
            'filter_days'           => '30',
